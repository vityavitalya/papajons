...
class TestCurrenciesAPI:
    ...
    def test_create_currency_duplicate(
        self,
        client
    ):
    ...
    def test_create_currency_invalid_code(
        self,
        client
    ):
    ...
    def test_get_currency_by_code_success(
        self,
        client
    ):
    ...
    def test_get_currency_by_code_not_found(
        self,
        client
    ):
...
class TestExchangeRatesAPI:
    ...
    def test_get_exchange_rate_by_pair_success(
        self,
        client
    ):
        ...
        assert response.status_code == status.HTTP_200_OK
        assert response.json()["rate"] == "0.920000"

    def test_get_exchange_rate_by_pair_not_found(
        self,
        client
    ):
    ...
    def test_update_exchange_rate_success(
        self,
        client
    ):
        ...
        assert response.status_code == status.HTTP_200_OK
        assert response.json()["rate"] == "0.950000"


class TestExchangeAPI:

    def setup_currencies_and_rates(
        self,
        client
    ):
    ...
    def test_convert_reverse_rate(
        ...
        response = client.get(
            "/exchange?from=EUR&to=USD&amount=100"
        )
    ...
    def test_convert_cross_rate(
        ...
        response = client.get(
            "/exchange?from=EUR&to=RUB&amount=100"
        )
    ...
    def test_convert_same_currency(
        ...
        response = client.get(
            "/exchange?from=USD&to=USD&amount=100"
        )
    ...
    def test_convert_currency_not_found(
        self,
        client
    ):
    ...
    def test_convert_no_rate_available(
        self,
        client
    ):
        ...
        response = client.get(
            "/exchange?from=USD&to=GBP&amount=100"
        )
